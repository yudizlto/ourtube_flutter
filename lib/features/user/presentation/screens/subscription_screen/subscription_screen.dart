...
import 'authenticated_subscription_screen.dart';
import 'unauthenticated_subscription_screen.dart';
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          body: isAuthenticated
              ? const AuthenticatedSubscriptionScreen()
              : const UnAuthenticatedSubscriptionScreen(),
